...
def create_raw_job_dict(global_jobs_descriptions,url_list,file_name):
    master_dict = {}
    for url in url_list:
        try:
    ...
    final = turn_dict_into_list(global_jobs_descriptions)
    return(final)
